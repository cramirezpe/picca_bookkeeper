...
#SBATCH --output /picca_bookkeeper/tests/test_files/output/guadalupe/main/dummy_catalog2/dMdB20_1.0.0_0/logs/xcf_lya-%j.out
#SBATCH --error /picca_bookkeeper/tests/test_files/output/guadalupe/main/dummy_catalog2/dMdB20_1.0.0_0/logs/xcf_lya-%j.err
