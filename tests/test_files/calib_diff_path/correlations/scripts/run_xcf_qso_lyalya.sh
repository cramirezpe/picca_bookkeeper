...
#SBATCH --output /picca_bookkeeper/tests/test_files/output/results/calib_diff/correlations/logs/xcf_qso_lyalya-%j.out
#SBATCH --error /picca_bookkeeper/tests/test_files/output/results/calib_diff/correlations/logs/xcf_qso_lyalya-%j.err
