...
#SBATCH --output /picca_bookkeeper/tests/test_files/output/results/calib_diff/correlations/logs/xdmat_lyalya-%j.out
#SBATCH --error /picca_bookkeeper/tests/test_files/output/results/calib_diff/correlations/logs/xdmat_lyalya-%j.err
