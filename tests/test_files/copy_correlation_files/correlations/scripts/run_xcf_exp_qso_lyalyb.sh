...
#SBATCH --output /picca_bookkeeper/tests/test_files/output/results/copycorrs/correlations/logs/xcf_exp_qso_lyalyb-%j.out
#SBATCH --error /picca_bookkeeper/tests/test_files/output/results/copycorrs/correlations/logs/xcf_exp_qso_lyalyb-%j.err
