...
command="picca_metal_dmat.py --in-dir /picca_bookkeeper/tests/test_files/output/v9.0.0/desi-2.0-1000/LyaCoLoRe/true_0.0.0_0/deltas/lyb/Delta --out /picca_bookkeeper/tests/test_files/output/v9.0.0/desi-2.0-1000/LyaCoLoRe/true_0.0.0_0/correlations/lyalyb_lyalya/metal.fits.gz --nproc 32 --rej 0.9999 --abs-igm CIV(eff) SiII(1260) SiIII(1207) SiII(1193) SiII(1190) --in-dir2 /picca_bookkeeper/tests/test_files/output/v9.0.0/desi-2.0-1000/LyaCoLoRe/true_0.0.0_0/deltas/lya/Delta"
